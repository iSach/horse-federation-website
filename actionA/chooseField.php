...
switch ($_POST["nomTable"]) {
    case "Club":
        ?>
        <form class="centered-box" action="displayTuples.php" method="post">
    ...
    case "Membre":
        ...
        <form class="centered-box" action="displayTuples.php" method="post">
            ...
            <input type="number" placeholder="Entrer le numéro identifiant du club associé au membre (falcutatif)"
                   name="id_club">
            <input type="submit" value="Soumettre">
        </form>
        <?php
    ...
    case "Cheval":
        ...
        <form class="centered-box" action="displayTuples.php" method="post">
            ...
            <input type="text" placeholder="Entrer la date de naissance du cheval YYYY-MM-JJ (falcutatif)"
                   name="date_naissance">
            <input type="submit" value="Soumettre">
        </form>
        <?php
    ...
    case "Obstacle":
        ...
        <form class="centered-box" action="displayTuples.php" method="post">
            ...
            <input type="number" placeholder="Entrer le nombre de haies de la course d'obstacles (facultatif)"
                   name="nb_haies">
            <input type="submit" value="Soumettre">
        </form>
        <?php
    ...
    case "Ordres":
        ...
        <form class="centered-box" action="displayTuples.php" method="post">
            ...
            <input type="text" placeholder="Entrer de la compétition de la compétition de dressage (falcutatif)"
                   name="nom_comp">

            <label><b>Numéro</b></label>
            <input type="number" placeholder="Entrer le numéro de l'ordre dans la liste d'ordres (falcutatif)"
                   name="numero">
