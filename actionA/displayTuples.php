...
case 'Club':
    ...
    if ($req->rowCount() == 0) {
        echo '<div class="centered-box"><p style=\'color:red\'>Désolé, aucun tuple ne correspond à vos contraintes. <br/> Veuillez réessayer</p></div>';
        break;
    }
...
case 'ProprieteDe':
    ...
    <h2 style="text-align: center; color: white; margin-top: 10px;">Tuples des propriétaires de chevaux : </h2>
    <table>
        <thead>
        <tr>
            <th>ID du membre</th>
...
case 'Competition':
    ...
    <h2 style="text-align: center; color: white; margin-top: 10px;">Tuples des compétitions : </h2>
    <table>
        <thead>
        <tr>
...
case 'Dressage':
    ...
    <h2 style="text-align: center; color: white; margin-top: 10px;">Tuples des compétitions de dressage</h2>
    <table>
        <thead>
        <tr>
...
case 'InstanceComp':
    ...
    <h2 style="text-align: center; color: white; margin-top: 10px;">Tuples des instances de compétition </h2>
    <table>
        <thead>
        <tr>
...
<h2 style="text-align: center; color: white; margin-top: 10px;">Tuples des participants à une compétition </h2>
        <table>
            <thead>
            <tr>
