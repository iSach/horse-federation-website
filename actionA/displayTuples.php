    ...
    <body>
        ...
        switch ($_SESSION['nomTable']) {
        	case 'Club':
        		if(!isset($_POST['numero']) OR !isset($_POST['nom']) OR !isset($_POST['code_postal']) OR !isset($_POST['localite']) OR !isset($_POST['rue']) OR !isset($_POST['num']) OR !isset($_POST['id_president'])){
        		 ...
        		 $_POST['nom'] = htmlentities(trim(str_replace("'" , "\'" ,  $_POST['nom'])));
                 $_POST['code_postal'] = str_replace("'" , "\'" ,  $_POST['code_postal']);
                 $_POST['localite'] = htmlentities(trim(str_replace("'" , "\'" ,  $_POST['localite'])));
                 $_POST['rue'] = htmlentities(trim(str_replace("'" , "\'" ,  $_POST['rue'])));
        ...
        <?php
        	...
        	case 'Membre':
        		...
        		$_POST['nom'] = htmlentities(trim(str_replace("'" , "\'" ,  $_POST['nom'])));
        		$_POST['prenom'] = htmlentities(trim(str_replace("'" , "\'" ,  $_POST['prenom'])));
       ...
       ?>
        ...
        <?php
        	...
        	case 'Cheval':
        		...
        		$_POST['numero'] = str_replace("'" , "\'" ,  $_POST['numero']);
                $_POST['nom'] = htmlentities(trim(str_replace("'" , "\'" ,  $_POST['nom'])));
                $_POST['sexe'] = htmlentities(trim(str_replace("'" , "\'" ,  $_POST['sexe'])));
        		$_POST['taille'] = str_replace("'" , "\'" ,  $_POST['taille']);
                $_POST['date_naissance'] = htmlentities(trim(str_replace("'" , "\'" ,  $_POST['date_naissance'])));
       ...
       ?>
        ...
        <?php
        	...
        	case 'Competition':
        		...
        		$_POST['nom'] = htmlentities(trim(str_replace("'" , "\'" ,  $_POST['nom'])));
        		$_POST['libelle'] = htmlentities(trim(str_replace("'" , "\'" ,  $_POST['libelle'])));
       ...
       ?>
        ...
        <?php
        	...
        	case 'Ordres':
        		...
        		$_POST['nom_comp'] = htmlentities(trim(str_replace("'" , "\'" ,  $_POST['nom_comp'])));
        		$_POST['numero'] = str_replace("'" , "\'" ,  $_POST['numero']);
            $_POST['ordre'] = htmlentities(trim(str_replace("'" , "\'" ,  $_POST['ordre'])));
